...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const tables = [
        {
            tab: '#user_list_table_tabs-11',
            tableId: '#user_list_table-11',
            table: null
        },
        {
            tab: '#user_list_table_tabs-22',
            tableId: '#user_list_table-22',
            table: null
        },
        {
            tab: '#user_list_table_tabs-33',
            tableId: '#user_list_table-33',
            table: null
        },
        {
            tab: '#user_list_table_tabs-44',
            tableId: '#user_list_table-44',
            table: null
        },
        {
            tab: '#user_list_table_tabs-55',
            tableId: '#user_list_table-55',
            table: null
        }
    ];
    ...
    tables.forEach(({ tab, table, tableId }) => {
